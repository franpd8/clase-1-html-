...
// otra opción es utilizar .slice(x,x) que sirve para arrays también 
...
// podemos ordenar arrays con .sort()
// reordenar un array al revés con .reverse()
...
console.log("El developer sabe de ", FullStackDeveloper.arrayLenguajes[0])
